...
String SQL = "INSERT INTO \"SEAN\".\"TEST_TABLE\" (PRODUCT, DATE, REVENUE) " +
"VALUES(?, ?, ?)";
...
// Set these values to the PreparedStatement object - these will be used as the Values in the
SQL statement
...
count+=1;
totalRecords+=1;
//check to see if the current count is 1000 OR the last element in the array - if true then
